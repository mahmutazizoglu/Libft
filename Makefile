...
PART_1 = ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		...
		ft_strnstr.c ft_strrchr.c ft_tolower.c ft_toupper.c ft_atoi.c \
		ft_calloc.c ft_substr.c ft_strjoin.c ft_strdup.c ft_strtrim.c \
